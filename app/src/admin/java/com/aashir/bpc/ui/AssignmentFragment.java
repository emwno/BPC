...
public class AssignmentFragment extends BaseAssignmentFragment implements SwipeRefreshLayout.OnRefreshListener, AssignmentAdapter.AssignmentAdminInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = new AssignmentAdapter(this, new ArrayList<AssignmentCard>());
